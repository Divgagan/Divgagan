...
function Push-Readme($repo, $content, $message = "Add professional README") {
    ...
    try {
        ...
        $body = @{ message = $message; content = $encoded } | ConvertTo-Json
    }
    try {
        ...
        Write-Host "✅ Updated README for: $repo" -ForegroundColor Green
    } catch {
        Write-Host "❌ Failed: $repo - $_" -ForegroundColor Red
    }
}

function Push-File($repo, $path, $content, $message) {
    $encoded = [Convert]::ToBase64String([System.Text.Encoding]::UTF8.GetBytes($content))
    try {
        $existing = Invoke-RestMethod -Uri "https://api.github.com/repos/$OWNER/$repo/contents/$path" -Headers $headers -ErrorAction Stop
        $sha = $existing.sha
        $body = @{ message = $message; content = $encoded; sha = $sha } | ConvertTo-Json
    } catch {
        $body = @{ message = $message; content = $encoded } | ConvertTo-Json
    ...
    try {
        Invoke-RestMethod -Uri "https://api.github.com/repos/$OWNER/$repo/contents/$path" -Method PUT -Headers $headers -Body $body | Out-Null
        Write-Host "  📄 Added $path to $repo" -ForegroundColor Cyan
    } catch {
        Write-Host "  ❌ Failed $path for $repo" -ForegroundColor Yellow
    }
}
...
**Gagan Diwakar** — [Portfolio](https://portfolio-gagan-nu.vercel.app/) | [LinkedIn](https://www.linkedin.com/in/gagan-diwakar-772134293/) | [GitHub](https://github.com/Divgagan)

<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=100&section=footer" width="100%"/>
"@
Push-Readme "Traffic_congestion_prediction_using_GNN" $readme "Add professional README with GNN architecture details"
...
tqdm>=4.65.0
"@
Push-File "Traffic_congestion_prediction_using_GNN" "requirements.txt" $requirements "Add requirements.txt"
...
models/checkpoints/
"@
Push-File "Traffic_congestion_prediction_using_GNN" ".gitignore" $gitignore "Add .gitignore"

# ─── 2. DSA_in_Cpp ────────────────────────────────────────────────────────────
$readme = @"
<div align="center">
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=DSA%20in%20C%2B%2B&fontSize=40&fontColor=fff&animation=twinkling&desc=Data%20Structures%20%26%20Algorithms&descSize=16&descAlignY=75" width="100%"/>
...
A structured collection of **Data Structures and Algorithms** implementations in C++ and Python. This repo serves as a personal reference and practice log for competitive programming and technical interviews.
...
[![LeetCode Stats](https://leetcard.jacoblin.cool/Gagan747?theme=dark&font=Fira%20Code&ext=contest)](https://leetcode.com/u/Gagan747/)

## 👤 Author

**Gagan Diwakar** — [Portfolio](https://portfolio-gagan-nu.vercel.app/) | [LeetCode](https://leetcode.com/u/Gagan747/) | [GitHub](https://github.com/Divgagan)

<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=100&section=footer" width="100%"/>
"@
Push-Readme "DSA_in_Cpp" $readme "Add professional README with topic coverage table"
...
**Gagan Diwakar** — [Portfolio](https://portfolio-gagan-nu.vercel.app/) | [LinkedIn](https://www.linkedin.com/in/gagan-diwakar-772134293/)

<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=100&section=footer" width="100%"/>
"@
Push-Readme "Porto_taxi_Traffic_trediction_" $readme "Add professional README"
$requirements2 = @"
numpy>=1.24.0
pandas>=2.0.0
matplotlib>=3.7.0
...
tqdm>=4.65.0
"@
Push-File "Porto_taxi_Traffic_trediction_" "requirements.txt" $requirements2 "Add requirements.txt"

# ─── 4. Master_traffic_AI_project_DL. ────────────────────────────────────────
$readme = @"
<div align="center">
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Master%20Traffic%20AI&fontSize=36&fontColor=fff&animation=twinkling&desc=Deep%20Learning%20Traffic%20Analysis%20Pipeline&descSize=16&descAlignY=75" width="100%"/>
...
An end-to-end **Deep Learning pipeline** for intelligent traffic flow analysis and prediction. This project encompasses data preprocessing, model training, hyperparameter tuning, and result visualization for traffic datasets.
...
- 🏗️ Multiple model architectures (CNN, LSTM, Hybrid)
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=100&section=footer" width="100%"/>
"@
Push-Readme "Master_traffic_AI_project_DL." $readme "Add professional README"
...
- 🛤️ **Parallel Dijkstra** — Shortest path with MPI process distribution
...
| Algorithm | Sequential | OpenMP (8T) | MPI (4P) | Hybrid (4P×8T) |
|---|---|---|---|---|
...
**Gagan Diwakar** — HPC Course Project | [Portfolio](https://portfolio-gagan-nu.vercel.app/)

<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=100&section=footer" width="100%"/>
"@
Push-Readme "Hybrid_paralell_graph_using_openmp_-_MPI_" $readme "Add professional README with architecture and benchmarks"
...
**Gagan Diwakar** — [Portfolio](https://portfolio-gagan-nu.vercel.app/) | [GitHub](https://github.com/Divgagan)

<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=100&section=footer" width="100%"/>
"@
Push-Readme "HPC_LAB_" $readme "Add professional README"

# ─── 7. DL_lab ───────────────────────────────────────────────────────────────
$readme = @"
<div align="center">
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Deep%20Learning%20Lab&fontSize=36&fontColor=fff&animation=twinkling&desc=Neural%20Networks%20%26%20DL%20Experiments&descSize=16&descAlignY=75" width="100%"/>
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=100&section=footer" width="100%"/>
"@
Push-Readme "DL_lab" $readme "Add professional README"
$requirements3 = @"
tensorflow>=2.12.0
torch>=2.0.0
torchvision>=0.15.0
...
Pillow>=9.5.0
"@
Push-File "DL_lab" "requirements.txt" $requirements3 "Add requirements.txt"
...
[![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-00FFFF?style=for-the-badge)](https://portfolio-gagan-nu.vercel.app/)
...
- 🌙 Dark mode aesthetic
- ⚡ Fast loading (deployed on Vercel CDN)
...
**Gagan Diwakar** — [LinkedIn](https://www.linkedin.com/in/gagan-diwakar-772134293/) | [GitHub](https://github.com/Divgagan)

<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=100&section=footer" width="100%"/>
"@
Push-Readme "Portfolio_Gagan" $readme "Add professional README"

# ─── 9. Demo_repository ──────────────────────────────────────────────────────
$readme = @"
# 🔬 Demo Repository

> My first GitHub repository — a sandbox for learning Git workflows, branching strategies, and version control best practices.

**Author:** [Gagan Diwakar](https://github.com/Divgagan) | [Portfolio](https://portfolio-gagan-nu.vercel.app/)
"@
Push-Readme "Demo_repository" $readme "Update README"

Write-Host ""
Write-Host "🎉 All repos updated! Check github.com/Divgagan" -ForegroundColor Magenta
